# Pulseboard — Job Application Tracker

Fullstack SaaS-Платформа для трекинга заявок на вакансии: воронка статусов, аналитика откликов, импорт вакансий из hh, real-time уведомления.
...
- **Основые enum**\
   ...
   Source: MANUAL, HH\
   NotificationType: INTERVIEW_REMINDER, STATUS_CHANGE, DEADLINE
